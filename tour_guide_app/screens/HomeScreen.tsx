        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>
                    Discover San José State University
                </Text>
            </View>
            ...
            <View style={styles.featuredSection}>
                ...
                <TouchableOpacity style={styles.tourCard}>
                    ...
                    <View style={styles.tourInfo}>
                        ...
                        <Text style={styles.tourDescription}>
                            Explore SJSU's most iconic locations including Tower
                            Hall and the MLK Library
                        </Text>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.tourCard}>
                    ...
                    <View style={styles.tourInfo}>
                        ...
                        <Text style={styles.tourDescription}>
                            Discover SJSU's role in tech innovation and startup
                            culture
                        </Text>
                    </View>
                </TouchableOpacity>
